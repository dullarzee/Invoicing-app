      ...
      <div className="flex items-center flex-col justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="bg-green-500 hover:bg-green-600 active:bg-green-700 text-white flex items-center gap-2"
          >
            {loading ? (
          ...
          <Card className="p-6 border border-slate-200 sticky top-8">
            ...
            <div className="mt-8 space-y-3">
              <Button
                onClick={handleSubmit}
                disabled={isFormInvalid}
                className="w-full bg-green-500 hover:bg-green-600 active:bg-green-700 text-white flex items-center justify-center gap-2"
              >
                {loading ? (
                  <Spinner className="w-5 h-5" />
                ) : (
